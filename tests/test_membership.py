...
class DexDBTest(Case):
    def test_membership(self):
        try:
            ...
            member_id = library.db.getcursor().selectvalue(
                'insert into'
            ...
            transaction_id = library.db.getcursor().selectvalue(
                'insert into'
            ...
            membership_id = library.db.getcursor().selectvalue(
                'insert into'
            ...
            new = Membership(library.db, membership_id)
